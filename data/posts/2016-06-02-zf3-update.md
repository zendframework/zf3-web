...
Please help us thank [Frank Brückner](http://www.froschdesignstudio.de) for the enormous amount of assistance he provided driving this milestone to completion!
...
You can test out the new skeleton using the following:
    ...
    <code class="language-bash">$ composer create-project "zendframework/skeleton-application:dev-develop" zend-project
